...
<script type="text/javascript" language="javascript"><xsl:value-of select="concat('&#10;/* &lt;![CDATA[ */&#10;', $jquery, '&#10;/* ]]&gt; */&#10;')" disable-output-escaping="yes" /></script>
<script type="text/javascript" language="javascript"><xsl:value-of select="concat('&#10;/* &lt;![CDATA[ */&#10;', $js, '&#10;//* ]]&gt; */&#10;')" disable-output-escaping="yes" /></script>
</xsl:template>
...
<div class="page">
	...
	<h2><a class="target" name="page.src">WSDL source code</a></h2>
	<div class="box">
		<div class="xml-proc">
...
<div class="page">
	<h2><a class="target" name="page.about">
		About <em>wsdl-viewer.xsl</em></a></h2>
